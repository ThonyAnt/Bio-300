...
\begin{enumAlph}
    ...
    catalyze the decomposition of \ch{H2O2} into water and oxygen gas.
    \item asdf
    \item Induced fit. The energy hill diagram below illustrates how catalase speeds up the reaction by lowering the activation energy required for the decomposition of \ch{H2O2} into water and oxygen gas.
    ...
    \begin{figure}[h]
        ...
        \begin{tikzpicture}
            ...
            {2*exp(-0.5*(x-5)^2) + 0.5*x - 1};
            \addlegendentry{Without Catalase}
            ...
            {1.5*exp(-0.5*(x-5)^2) + 0.5*x - 1.5};
            \addlegendentry{With Catalase}

            % Labels
            \node at (axis cs:5,2.5) [anchor=south] {Activation Energy};
            \node at (axis cs:5,1.5) [anchor=south] {Lowered Activation Energy};
            \node at (axis cs:0,0) [anchor=east] {Reactants};
            \node at (axis cs:10,-2) [anchor=west] {Products};
